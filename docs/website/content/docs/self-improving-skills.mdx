...
Nakama is extending this area over time — for example, better visibility into which skills are used, and gentle suggestions after complex turns when saving a skill might help. What you have today is agent-driven skill authoring plus optional org-admin approval.
