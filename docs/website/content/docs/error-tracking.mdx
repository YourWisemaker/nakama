...
description: "Send this instance's own errors to the Sentry, GlitchTip, or Bugsink project you already run."
---
...
| Anything after a variable whose name contains `TOKEN`, `KEY`, `SECRET`, or `PASSWORD` | `<redacted>` |
